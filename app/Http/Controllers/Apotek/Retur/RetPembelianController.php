...
class RetPembelianController extends Controller
{
    ...
    {
        return view('apotek.retur_pembelian.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('apotek.retur_pembelian.create');
    }
    ...
    public function getPembeliandetail(Request $request)
    {
        ...
        $data_pembelian_detail = DB::table('tr_penerimaan_h')
            ...
            ->select(
                ...
                'tr_penerimaan_d.harga_beli as harga',
                'tr_penerimaan_d.jml_beli',
                'tr_penerimaan_d.jml_terima as qty_beli',
                'tr_penerimaan_d.id_produk_unit as id_unit',
                'm_produk_unit.nama_unit',
                'tr_penerimaan_d.diskon_persen as diskon_item',
                'tr_penerimaan_d.diskon_rp as diskon_item_rp',
                'tr_penerimaan_d.ppn_persen as ppn_item',
                'tr_penerimaan_d.ppn_rp as ppn_item_rp',
                'tr_penerimaan_d.subtotal as total'
            )
            ->where('tr_penerimaan_h.no_faktur', $request->value);
