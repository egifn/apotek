...
class LapPenjualanPanelPerTransaksiController extends Controller
{
    ...
    {
        return view('apotek.laporan.penjualan_pertransaksi_panel.index');
    }
    ...
    public function view(Request $request)
    {
        ...
        if ($tombol_excel == 'excel') {
            ...
            return view('apotek.laporan.penjualan_pertransaksi.view', compact('data_penjualan_pertransaksi_excel'));
