...
class LapStokOpnameController extends Controller
{
    ...
    {
        return view('apotek.laporan.stok_opname.index');
    }
    ...
    public function getViewOpname(Request $request)
    {
        $dataPenjualan = DB::table('stokopname_h')
            ...
            ->select(
                'stokopname_h.kode_opname',
                'stokopname_h.tgl_opname',
                'stokopname_d.kode_produk',
                'm_produk.nama_produk',
                'stokopname_d.jml_sistem',
                'stokopname_d.jml_fisik',
                'stokopname_d.selisih'
            )
    ...
    public function view(Request $request)
    {
        ...
        return view('apotek.laporan.stok_opname.view', compact('dataOpname'));
    }
}
