...
class LapReturKadaluarsaController extends Controller
{
    ...
    {
        return view('apotek.laporan.retur_kadaluarsa.index');
    }
    ...
    public function getDataReturKadaluarsa(Request $request)
    {
        ...
        $data_kadaluarsa = DB::table('m_produk')
            ...
            ->select(
                'm_produk.created_at AS tgl_transaksi',
                'm_produk.id',
    ...
    public function view(Request $request)
    {
        ...
        if ($tombol_excel == 'excel') {
            ...
            return view('apotek.laporan.retur_kadaluarsa.view', compact('data_kadaluarsa_excel'));
