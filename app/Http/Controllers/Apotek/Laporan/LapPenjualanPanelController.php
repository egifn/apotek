...
class LapPenjualanPanelController extends Controller
{
    ...
    {
        return view('apotek.laporan.penjualan_panel.index');
    }
    ...
    public function view(Request $request)
    {
        ...
        if ($tombol_excel == 'excel') {
            ...
            return view('apotek.laporan.penjualan_panel.view', compact('data_penjualan_excel'));
            ...
            // return view('apotek.laporan.penjualan.index', compact('data_penjualan'));
