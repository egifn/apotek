...
class ObatController extends Controller
{
    public function index()
    {
        ...
        return view('apotek.master_data.obat.index', compact('data_cabang', 'data_kategori', 'data_jenis', 'data_unit', 'data_vendor'));
    }
    ...
    public function getDataProduk(Request $request)
    {
        $data_obat = DB::table('m_produk')
            ...
            ->select(
                ...
                'm_produk.id_unit',
                'produk_unit_terkecil.nama_unit as nama_unit_terkecil',
    ...
    public function view(Request $request)
    {
        ...
        if ($tombol_excel == 'excel') {
            ...
            return view('apotek.master_data.obat.view', compact('data_obat_excel'));
