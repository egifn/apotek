...
class SupplierController extends Controller
{
    ...
    public function getDataSupplier(Request $request)
    {
        $data_supplier = DB::table('m_supplier')
                        ->select('m_supplier.id','m_supplier.kode_supplier','m_supplier.nama_supplier','m_supplier.alamat',
                                'm_supplier.cp','m_supplier.tlp','m_supplier.email','m_supplier.id_user_input','users.name')
	...
	if($tombol_excel == 'excel'){
		...
		->where('m_supplier.nama_supplier', 'like', "%$cari_supplier%")
            ...
            return view ('master_data.supplier.view', compact('data_supplier_excel'));
