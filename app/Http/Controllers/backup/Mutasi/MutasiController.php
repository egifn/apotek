...
class MutasiController extends Controller
{
    ...
    public function getDataMutasi()
    {
        ...
        if (Auth::user()->type == '1') {  //jika Super Admin
            $data_mutasi = DB::table('tr_mutasi_h')
                            ...
                            ->select('tr_mutasi_h.kode_mutasi','tr_mutasi_h.tgl_mutasi','tr_mutasi_h.waktu_mutasi','tr_mutasi_h.kode_cabang_asal',
                                        'cabang_asal.nama_cabang as nama_cabang_asal','tr_mutasi_h.kode_cabang_tujuan',
                                        'cabang_tujuan.nama_cabang as nama_cabang_tujuan','tr_mutasi_h.id_user_input','users.name')
    ...
    public function create(Request $request)
    {
        ...
        return view ('mutasi.create', compact('kode','data_cabang_asal','data_cabang_tujuan'));
    }
    ...
    public function pdf(Request $request)
    {
        ...
        $data_mutasi = DB::table('tr_mutasi_h')
                        ...
                        ->join('m_cabang AS cabang_asal','tr_mutasi_h.kode_cabang_asal','=','cabang_asal.kode_cabang') 
                        ->join('m_cabang AS cabang_tujuan','tr_mutasi_h.kode_cabang_tujuan','=','cabang_tujuan.kode_cabang') 
                        ->select('tr_mutasi_h.kode_mutasi',
