...
class RetPenjualanController extends Controller
{
    ...
    public function create(Request $request){
        ...
        return view ('retur_penjualan.create');
    }
    ...
    public function getPenjualanModal(Request $request)
    {
        ...
        if (Auth::user()->type == '1') {  //jika Super Admin
            $data_penjualan = DB::table('tr_penjualan_h')
                    ...
                    ->select('tr_penjualan_h.kode_penjualan','tr_penjualan_h.tgl_penjualan','tr_penjualan_h.jenis_penjualan',
    ...
    public function getPenjualandetail(Request $request)
    {
        $data_penjualan_detail = DB::table('tr_penjualan_h')
                    ...
                    ->select('tr_penjualan_d.kode_produk','m_produk.nama_produk','tr_penjualan_d.harga','tr_penjualan_d.qty','tr_penjualan_d.id_produk_unit','m_produk_unit.nama_unit','tr_penjualan_d.diskon','tr_penjualan_d.diskon_rp',
