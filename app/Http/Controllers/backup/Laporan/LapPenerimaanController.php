...
class LapPenerimaanController extends Controller
{
    ...
    {
        return view ('laporan.penerimaan.index');
    }
    ...
    public function getDataPenerimaan(Request $request)
    {
        ...
        $data_penerimaan = DB::table('tr_penerimaan_h')
                        ...
                        ->select('tr_penerimaan_h.kode_penerimaan','tr_penerimaan_h.tgl_penerimaan','tr_penerimaan_h.kode_cabang','m_cabang.nama_cabang','tr_penerimaan_h.kode_pembelian',
                        'tr_pembelian_h.jenis_surat_pesanan','tr_pembelian_h.pembelian','tr_pembelian_h.kode_supplier','tr_pembelian_h.tgl_jatuh_tempo','m_supplier.nama_supplier','tr_penerimaan_h.no_faktur','tr_penerimaan_h.diskon_rupiah',
                        'tr_penerimaan_d.harga_beli_lama','tr_penerimaan_d.kode_produk','m_produk.nama_produk','tr_penerimaan_d.jml_beli','tr_penerimaan_d.jml_terima','tr_penerimaan_d.harga_beli','tr_penerimaan_d.diskon_rp','tr_penerimaan_d.ppn_rp',
    ...
    public function view(Request $request)
    {
        ...
        if($tombol_excel == 'excel'){
            ...
            return view ('laporan.penerimaan.view', compact('data_penerimaan_excel','date'));
