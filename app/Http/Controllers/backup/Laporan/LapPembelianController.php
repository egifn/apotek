...
class LapPembelianController extends Controller
{
    ...
    public function getDataPembelian(Request $request)
    {
        ...
        $data_pembelian = DB::table('tr_pembelian_h')
                        ...
                        ->select('tr_pembelian_h.kode_pembelian','tr_pembelian_h.tgl_pembelian','tr_pembelian_h.jenis_surat_pesanan','tr_pembelian_h.pembelian',
                        'tr_pembelian_h.jenis_transaksi','tr_pembelian_h.tgl_jatuh_tempo','tr_pembelian_h.kode_supplier','m_supplier.nama_supplier','tr_pembelian_h.diskon',
                        'tr_pembelian_h.status_pembelian','tr_pembelian_h.status_pembayaran','tr_penerimaan_h.no_faktur','tr_pembelian_h.kode_cabang','m_cabang.nama_cabang','tr_pembelian_d.kode_produk',
                        'm_produk.nama_produk','m_produk.tipe','tr_pembelian_d.qty_kecil','tr_pembelian_d.qty_beli','tr_pembelian_d.harga','tr_pembelian_d.diskon_item','tr_pembelian_d.diskon_item_rp','tr_pembelian_d.ppn_item',
                        'tr_pembelian_d.ppn_item_rp','tr_pembelian_d.total')
                        ->groupBy('tr_pembelian_h.kode_pembelian','tr_pembelian_h.tgl_pembelian','tr_pembelian_h.jenis_surat_pesanan','tr_pembelian_h.pembelian',
                        'tr_pembelian_h.jenis_transaksi','tr_pembelian_h.tgl_jatuh_tempo','tr_pembelian_h.kode_supplier','m_supplier.nama_supplier','tr_pembelian_h.diskon',
                        'tr_pembelian_h.status_pembelian','tr_pembelian_h.status_pembayaran','tr_penerimaan_h.no_faktur','tr_pembelian_h.kode_cabang','m_cabang.nama_cabang','tr_pembelian_d.kode_produk',
                        'm_produk.nama_produk','m_produk.tipe','tr_pembelian_d.qty_kecil','tr_pembelian_d.qty_beli','tr_pembelian_d.harga','tr_pembelian_d.diskon_item','tr_pembelian_d.diskon_item_rp','tr_pembelian_d.ppn_item',
                        'tr_pembelian_d.ppn_item_rp','tr_pembelian_d.total')
    ...
    public function view(Request $request)
    {
        ...
        if($tombol_excel == 'excel'){
            ...
            return view ('laporan.pembelian.view', compact('data_pembelian_excel'));
