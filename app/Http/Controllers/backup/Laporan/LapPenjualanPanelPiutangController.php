...
class LapPenjualanPanelPiutangController extends Controller
{
    ...
    {
        return view ('laporan.penjualan_piutang_panel.index');
    }
    ...
    public function getDataPenjualanPertransaksi(Request $request)
    {
        ...
        $data_penjualan_pertransaksi = DB::table('tr_penjualan_h')
                    ...
                    ->select('tr_penjualan_h.kode_penjualan','tr_penjualan_h.tgl_penjualan','tr_penjualan_h.waktu_penjualan','tr_penjualan_h.jenis_penjualan','tr_penjualan_h.status_bayar'
    ...
    public function view(Request $request)
    {
        ...
        if($tombol_excel == 'excel'){
            ...
            return view ('laporan.penjualan_piutang_panel.view', compact('data_penjualan_pertransaksi_excel'));
