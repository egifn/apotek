...
class LapNarkotikaPsikotropikaController extends Controller
{
    ...
    {
        return view('laporan.narkotika_psikotropika.index');
    }
    ...
    public function getData(Request $request)
    {
        ...
        $data_item = DB::table('m_produk')
                ...
                ->select('m_produk.kode_produk','m_produk.nama_produk','m_produk.id_unit','m_produk_unit.nama_unit','stok_in_out.kode_cabang','m_cabang.nama_cabang',
    ...
    public function view(Request $request)
    {
        ...
        if($tombol_excel == 'excel'){
            ...
            return view ('laporan.narkotika_psikotropika.view', compact('data_excel'));
