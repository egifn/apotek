...
class PembelianController extends Controller
{
    ...
    {            
        return view ('tr_pembelian.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        return view ('tr_pembelian.create', compact('kode','cart'));
    }
    ...
    public function getProduk(Request $request)
    {
        ...
        $data_produk = DB::table('m_produk')
                    ...
                    ->select('m_produk.kode_produk','m_produk.barcode','m_produk.nama_produk','m_produk.id_jenis','m_jenis_obat.nama_jenis',
    ...
    public function getViewPembelian(Request $request)
    {
        $dataPembelian = DB::table('tr_pembelian_h')
                ...
                ->join('users','tr_pembelian_h.id_user_input','=','users.id')
                ->join('m_cabang','tr_pembelian_h.kode_cabang','=','m_cabang.kode_cabang')
                ->select('tr_pembelian_d.kode_produk','m_produk.nama_produk','tr_pembelian_d.harga','tr_pembelian_d.qty_kecil','tr_pembelian_d.qty_beli','m_produk_unit_varian.qty AS qty_unit_kecil','m_produk_unit_varian.margin_persen','m_produk_unit_varian.margin_rp','m_produk_unit.nama_unit','m_produk_unit.id',
                'tr_pembelian_d.diskon_item','tr_pembelian_d.diskon_item_rp','tr_pembelian_d.ppn_item','tr_pembelian_d.ppn_item_rp','tr_pembelian_d.total','tr_pembelian_d.margin_rp_lama','tr_pembelian_d.margin_persen_lama','tr_pembelian_d.harga_jual_lama')
                ->where('tr_pembelian_h.kode_pembelian', $request->kode_pembelian)
                ->groupBy('tr_pembelian_d.kode_produk','m_produk.nama_produk','tr_pembelian_d.harga','tr_pembelian_d.qty_kecil','tr_pembelian_d.qty_beli','m_produk_unit_varian.qty','m_produk_unit_varian.margin_persen','m_produk_unit_varian.margin_rp','m_produk_unit.nama_unit','m_produk_unit.id',
                'tr_pembelian_d.diskon_item','tr_pembelian_d.diskon_item_rp','tr_pembelian_d.ppn_item','tr_pembelian_d.ppn_item_rp','tr_pembelian_d.total','tr_pembelian_d.margin_rp_lama','tr_pembelian_d.margin_persen_lama','tr_pembelian_d.harga_jual_lama')
                ->get();
        $output = [
            'status'  => true,
    ...
    {   
        $data = DB::table('tr_pembelian_h')
                ...
                ->join('m_cabang','tr_pembelian_h.kode_cabang','=','m_cabang.kode_cabang')
                ->select('tr_pembelian_h.kode_pembelian','tr_pembelian_h.tgl_pembelian','tr_pembelian_h.jenis_surat_pesanan','users.name','m_supplier.nama_supplier',
                'm_supplier.alamat','m_supplier.tlp','m_cabang.alamat as alamat_cabang','m_cabang.tlp as tlp_cabang')
                ->where('tr_pembelian_h.kode_pembelian', $request->kode_pembelian)
                ->first();
        ...
        $dataPembelian = DB::table('tr_pembelian_h')
                ...
                ->join('users','tr_pembelian_h.id_user_input','=','users.id')
                ->join('m_cabang','tr_pembelian_h.kode_cabang','=','m_cabang.kode_cabang')
                ->select('tr_pembelian_d.kode_produk','m_produk.nama_produk','tr_pembelian_d.harga','tr_pembelian_d.qty_kecil','tr_pembelian_d.qty_beli','m_produk_unit.nama_unit',
                'tr_pembelian_d.diskon_item','tr_pembelian_d.diskon_item_rp','tr_pembelian_d.ppn_item','tr_pembelian_d.ppn_item_rp','tr_pembelian_d.total')
                ->where('tr_pembelian_h.kode_pembelian', $request->kode_pembelian)
                ->get();
