...
{   
    ...
    {
    	return view ('tr_penjualan.index');
    }
    ...
    public function getDataPenjualan()
    {
        ...
        if (Auth::user()->type == '1') {  //jika Super Admin
            $data_penjualan = DB::table('tr_penjualan_h')
                    ...
                    ->groupBy('tr_penjualan_h.kode_penjualan',
                            'tr_penjualan_h.tgl_penjualan',
                            'tr_penjualan_h.waktu_penjualan',
                            'tr_penjualan_h.jenis_penjualan',
                            'tr_penjualan_h.cara_bayar',
    ...
    {   
    	...
    	return view ('tr_penjualan.create', compact('kode'));
    }
    ...
    public function getViewPenjualan(Request $request)
    {
        $dataPenjualan = DB::table('tr_penjualan_h')
                ...
                ->select('tr_penjualan_d.kode_produk','m_produk.nama_produk','tr_penjualan_d.harga','tr_penjualan_d.qty','m_produk_unit.nama_unit',
                'tr_penjualan_d.diskon','tr_penjualan_d.diskon_rp','tr_penjualan_d.ppn','tr_penjualan_d.ppn','tr_penjualan_d.ppn_rp','tr_penjualan_d.biaya_tambahan','tr_penjualan_d.tuslah','tr_penjualan_d.embalase','tr_penjualan_d.total',
    ...
    public function getViewPenjualanFooter(Request $request)
    {
        $dataPenjualanFooter = DB::table('tr_penjualan_h')
                            ->select('tr_penjualan_h.pembulatan','tr_penjualan_h.total_bayar','tr_penjualan_h.jml_bayar','tr_penjualan_h.kembali',
                            'tr_penjualan_h.cara_bayar','tr_penjualan_h.bank')
                            ->where('tr_penjualan_h.kode_penjualan', $request->kode_penjualan)
                            ->first();
    ...
    public function pdf(Request $request)
    {
        $data = DB::table('tr_penjualan_h')
                ->join('m_cabang','tr_penjualan_h.kode_cabang','=','m_cabang.kode_cabang')
                ->join('users','tr_penjualan_h.id_user_input','=','users.id')
                ->select('tr_penjualan_h.kode_penjualan','tr_penjualan_h.tgl_penjualan','tr_penjualan_h.waktu_penjualan','tr_penjualan_h.jenis_penjualan','tr_penjualan_h.cara_bayar',
                'tr_penjualan_h.pembulatan','tr_penjualan_h.total_bayar','tr_penjualan_h.tgl_jatuh_tempo','tr_penjualan_h.kembali','tr_penjualan_h.id_user_input','tr_penjualan_h.kode_cabang','m_cabang.nama_cabang','m_cabang.alamat','m_cabang.tlp','users.name')
                ->where('tr_penjualan_h.kode_penjualan', $request->kode_penjualan)
                ->first();
        ...
        $dataPenjualan = DB::table('tr_penjualan_h')
                ...
                //         }) 
                ->select('tr_penjualan_h.kode_penjualan','tr_penjualan_d.kode_produk','m_produk.nama_produk','tr_penjualan_d.qty','m_produk_unit.nama_unit','tr_penjualan_d.harga',
                'tr_penjualan_d.diskon','tr_penjualan_d.diskon_rp')
                ->where('tr_penjualan_h.kode_penjualan', $request->kode_penjualan)
                ->get();
