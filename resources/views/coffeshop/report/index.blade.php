            ...
            <div class="table-card">
                <div class="table-card-header" style="display: flex; flex-wrap: wrap;gap: 5px;">
                    ...
                    <div class="row g-2" style="width: 100%; align-items: center;">
                        ...
                        <div class="col-md-2" id="daily_container" style="display: none;">
                            <input type="date" id="filter_date_daily" class="form-control form-control-sm">
                        </div>
                        <div class="col-md-2" id="monthly_container" style="display: none;">
                            <input type="month" id="filter_date_monthly" class="form-control form-control-sm">
                        </div>
                        <div class="col-md-2" id="yearly_container" style="display: none;">
    ...
    <script>
        ...
        async function fetchData() {
            ...
            if (reportType === 'stock') {
                ...
                url = "{{ route('coffeshop.reports.purchase') }}";
            } else {
                url = "{{ route('coffeshop.reports.sales') }}";
            }
                ...
                if (reportType === 'stock') {
                    ...
                    data.forEach((item, index) => {
                        tableHTML += `<tr>
                                        <td>${index + 1}</td>
                                        <td>${item.name}</td>
                                        <td>${item.stock_available.toString()}</td>
