                ...
                <form id="nonMemberFormInput" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="lokasi" name="lokasi" value="coffeshop"
                                readonly>
                        </div>
...
@push('scripts')
    ...
    <script>
        async function fetchData(search, limit) {
            try {
                let url = `{{ route('coffeshop.master.user.data') }}`;
        ...
        if (buttonInsert) {
            buttonInsert.addEventListener('click', async function() {
                ...
                try {
                    ...
                    const response = await axios.post(`{{ route('coffeshop.master.user.store') }}`, formData);
                    const data = response.data;
    ...
    <script>
        ...
        if (buttonDelete) {
            buttonDelete.addEventListener('click', async function() {
                ...
                try {
                    const response = await axios.post(`{{ route('coffeshop.master.user.destroy') }}`, {
