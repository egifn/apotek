...
<body>
    ...
    <table>
        <tr>
            <td width="530">
                <div align="center">
                    <u><font size="4">SURAT PESANAN OBAT-OBAT TERTENTU</font></u><br>
    ...
    <table>
        ...
        <br>
        <tr>
            <td colspan="3">Mengajukan pesanan obat yang mengandung obat-obat tertentu kepada :</td>
        </tr>
        <tr>
        ...
        <br>
        <tr>
            <td colspan="3">jenis obat yang mengandung obat-obat tertentu yang dipesan adalah :</td>
        </tr>
    </table>
    ...
    <table >
        <tr>
            <td colspan="3">Obat yang mengandung obat-obat tertentu tersebut akan dipergunakan untuk :</td>
        </tr>
