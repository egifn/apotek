...
<body>
    ...
    <table>
        <tr>
            <td width="530">
                <div align="center">
                    <u><font size="4">SURAT PESANAN OBAT JADI PREKUSOR FARMASI</font></u><br>
    ...
    <table>
        ...
        <br>
        <tr>
            <td colspan="3">Mengajukan pesanan Obat Jadi Prekusor Farmasi kepada :</td>
        </tr>
        <tr>
        ...
        <br>
        <tr>
            <td colspan="3"> dengan Obat Jadi Prekusor Farmasi yang dipesan adalah :</td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            <td colspan="3">Obat Jadi Prekusor Farmasi tersebut akan dipergunakan untuk :</td>
        </tr>
