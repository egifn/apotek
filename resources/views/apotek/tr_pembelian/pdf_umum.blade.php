...
<body>
    ...
    <table>
        <tr>
            <td width="530">
                <div align="center">
                    APOTEK SINDANGSARI FARMA <br>
                    {{ $data->alamat_cabang }} <br>
                    Kota Bandung <br>
                    Telp. {{ $data->tlp_cabang }} <br>
                    <hr>
                    <u><font size="4">SURAT PESANAN</font></u><br>
    ...
    <table>
        ...
        <br> --}}
        <tr>
            <td colspan="3">Mengajukan pesanan kepada :</td>
        </tr>
        <tr>
        ...
        <br>
        <tr>
            <td colspan="3">dengan yang dipesan adalah :</td>
        </tr>
    </table>
    ...
    <table border='1' style="border-collapse: collapse; border-color: black; width: 100%;" >
        ...
        <tbody>
            ...
            <?php $angka = $val->qty_beli ?>
            <tr>
                <td>{{ $val->nama_produk }}</td>
                <td>{{ $val->nama_unit }}</td>
                <td></td>
                <td align="center">{{ $val->qty_beli }} ({{ terbilang($angka) }})</td>
    ...
    <table>    
        <tr>
            <td width="320">
            <td width="190" align="center">Bandung, {{  date('d-M-Y', strtotime($data->tgl_pembelian)) }}</td>
        </tr>
        <br>
        <br>
        <br>
        ...
        <tr>
            <td width="320">
            <td width="190" align="center"><u>apt. Aristo Fajar N,S.Farm</u></td>
        </tr>
        <tr>
            <td width="320">
