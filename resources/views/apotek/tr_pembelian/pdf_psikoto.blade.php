...
<body>
    ...
    <table>
        <tr>
            <td width="530">
                <div align="center">
                    <u><font size="4">SURAT PESANAN PSIKOTROPIKA</font></u><br>
    ...
    <table>
        ...
        <br>
        <tr>
            <td colspan="3">Mengajukan pesanan Psikotropika kepada :</td>
        </tr>
        <tr>
        ...
        <br>
        <tr>
            <td colspan="3">dengan Psikotropika yang dipesan adalah :</td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            <td colspan="3">Psikotropika tersebut akan dipergunakan untuk :</td>
        </tr>
